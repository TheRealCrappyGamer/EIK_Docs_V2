...
This is how you can integrate Kronos Matchmaking with EIK. If you have any questions or need help with the integration, feel free to ask in the [EIK Discord Server](https://discord.gg/3RpDvvKNpJ).